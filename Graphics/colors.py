...
for name, red, green, blue, hexcolor in colorList:
    assert type(red) == int and type(green) == int and type(blue) == int
    assert 0 <= red < 256 and 0 <= green < 256 and 0 <= blue < 256
...
if __name__ == "__main__":
    with open("colors.html", "w") as web:
        ...
        for index, (name, red, green, blue, hexcode) in enumerate(colorList):
            if index % 4 == 0:
                if index > 0:
                    web.write('</tr>')
                web.write('<tr>\n')
            ...
            web.write(
                ...
                % (hexcode, fontcolor, name, red, green, blue))
