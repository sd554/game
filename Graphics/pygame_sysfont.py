...
def lookup_sys(name, size, bold=False, italic=False):
    """lookup_sys(name, size, bold=False, italic=False) -> (fontpath, size, bold, italic)

       look up a system font based on criteria

       This will search the system fonts for the given font
       name. You can also enable bold or italic styles, and
       the appropriate system font will be selected if available.

       This will always return a valid font description, and will
    ...
    if not fontname:
        fontname = os.path.join(os.path.dirname(os.path.realpath(__name__)), "freesansbold.ttf")

    return fontname, size, set_bold, set_italic
